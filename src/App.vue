<template>
  ...
  <div class="card">
    ...
    <button @click="changeWizard1Want">Change wand</button>
 ...
 * 
 * - Watchers allow you to perform actions in response to changes in your component's data.
 * 
...
function changeWizard1Want(){
  wizard1.value.wand = {
    core: 'Dragon hearstring',
    wood: 'Vine'
  }
}

...
/**
 *  watchEffect is a function that automatically tracks reactive dependencies and reruns when any of them change
 *  unlike the regular watch function which requires specifying the exact reactive sources to observe.
 * 
 *  watchEffect works implicitly tracking any reactive data used inside callback function
 */
...
watchEffect(() => { // By default, watchEffect is not deep watch
